...
"On `station44` we need a unit `wg-marker.service` that runs once and writes the hostname into `/opt/wg/marker/ran`. No daemon, no loop — run it, it writes, it's done."
