...
create table public.orders (id serial primary key, customer_id integer not null, total numeric(10,2) not null);
insert into public.orders (customer_id, total) values (1, 100.00), (2, 20.00), (42, 9.99), (3, 75.50), (42, 1.00);
SQL
