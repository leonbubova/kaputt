...
"Audit finding: process in `wg-api` runs as uid 0. Fix it in the image (`~/.k8s-wargame/docker/24-runs-as-root/`), not with a runtime flag — the image goes to other teams too."
