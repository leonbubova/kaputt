...
Work dir: `~/.k8s-wargame/helm/27-subchart/`. Goal: `shop` and `shop-cache` both available, page reachable. Don't remove the init container — the app really needs the cache.
