...
Your copy of the chart: `~/.k8s-wargame/helm/14-template-syntax/web`. Goal: release `web` is `deployed` in `wg-helm`, pod ready, page at `http://web.wg-helm.svc/`. Keep the memory limit.
