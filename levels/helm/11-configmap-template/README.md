...
Chart copy: `~/.k8s-wargame/helm/11-configmap-template/web`. Goal: pod available, `kubectl exec deploy/web -- printenv GREETING` prints the value from `values.yaml`; the ConfigMap is part of the release.
