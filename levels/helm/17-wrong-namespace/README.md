...
Chart copy: `~/.k8s-wargame/helm/17-wrong-namespace/shop`. Goal: release `shop` deployed in `wg-helm` and reachable at `http://shop.wg-helm.svc/`; no stray copy left anywhere else.
