...
Work dir: `~/.k8s-wargame/helm/10-values-file/`. Goal: `values-prod.yaml` exists, release `shop` deployed from it, 2 pods, page shows `env=prod domain=shop.example.com`.
