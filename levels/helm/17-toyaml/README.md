...
Chart copy: `~/.k8s-wargame/helm/17-toyaml/web`. Goal: ConfigMap `web-html` holds `index.html` and `robots.txt` from `values.yaml`, page still shows `hello from the configmap`.
