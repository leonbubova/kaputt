...
fun main() {
    ...
    println("== prices");    val t = System.currentTimeMillis()
    val prices = runBlocking { fetchAll(listOf("A1", "B2", "C3", "ZZ", "D4", "E5")) }
    println("${prices.size} prices in ${System.currentTimeMillis() - t} ms: $prices")
}
